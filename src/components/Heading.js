        ...
        <Card style={{'backgroundColor': '#deedd6'}}>
            <div className='row'>
                ...
                <div className='col-4 text-end'>
                    <Image style={{'max-height': '350px'}} fluid src="https://www.instacart.com/image-server/x428/www.instacart.com/assets/homepage/homepage_background_full_m3_cropped-8d2d286263821da7decd7c61fb1db1eb0e3dec13e0c356277d6d3cb7484c024a.jpg"/>
                </div>            
            </div>
        </Card>
    </div>
